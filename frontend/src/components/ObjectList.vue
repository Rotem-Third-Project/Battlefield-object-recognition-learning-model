      ...
      <table id="object-list">
        ...
        <tbody>
          ...
          <tr
            ...
            :class="[
              threatClass(obj.threat),
              { selected: selectedObjectId === obj.track_id },
            ]"
          ...
          >
            ...
            <td :class="['priority-cell', `rank-${obj.rank || '3'}`]">
              {{ obj.rank || "-" }}
            </td>
          </tr>
        </tbody>
...
export default {
  ...
  computed: {
    ...
    displayObjects() {
      ...
      return Object.values(this.objectStateCache).sort(
...
#object-list th:nth-child(1) {
  width: 55%;
}
#object-list th:nth-child(2) {
  width: 10%;
}
#object-list th:nth-child(3) {
  width: 20%;
}
#object-list th:nth-child(4) {
  width: 15%;
}
