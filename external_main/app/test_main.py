...
from models.sep_detect import process_image_array
...
async def encode_loop():
    while True:
        ...
        print(f"yolo 결과 출력: {arr[1]}, deepsort 결과 출력: {arr[2]}")
        small = cv2.resize(arr[0], DESIRED_SIZE, interpolation=cv2.INTER_LINEAR)
