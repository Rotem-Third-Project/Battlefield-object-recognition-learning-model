...
move_command = ["W","W","W","W","W","W","W","W","W","W","W","STOP","W","W","W","W","W","W","W","W","W","W","W","W","W","STOP","W","W","W","W","W","W","W","W","W","W","W","W","W","W","W","STOP","W","W","W","W","W","W","W","W","W","W","W","W","STOP","W","W","W","W","W","W","W","W","W","W","W","W"]
...
model = YOLO("best.pt")  # 미리 모델을 로드해두는 게 성능면에서 좋음
...
def detect():
    ...
    for box in detections:
        ...
        if class_id == 0 or class_id == 1:  # person만 추적 대상으로
            x1, y1, x2, y2 = box[:4]
            cx = (x1 + x2) / 2
            cy = (y1 + y2) / 2
